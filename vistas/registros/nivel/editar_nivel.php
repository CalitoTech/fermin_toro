...
// Obtener ID del nivel a editar
$idNivel = isset($_GET['id']) ? (int)$_GET['id'] : 0;
if ($idNivel <= 0) {
...
$nivel = $nivelModel->obtenerPorId($idNivel); // Cargar datos
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-danger text-white text-center">
                            <h4 class="mb-0"><i class='bx bxs-user-edit'></i> Editar Nivel</h4>
                        </div>
                        <div class="card-body p-4">

                            <form action="../../../controladores/NivelController.php?action=editar" method="POST" id="editar">
                                        ...
                                        <div class="añadir__grupo" id="grupo__nivel">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input 
                                                    ...
                                                    value="<?= htmlspecialchars($nivel['nivel']) ?>">
                                                <i class="añadir__validacion-estado fas fa-times-circle"></i>
                                            </div>
                                            <p class="añadir__input-error">El nivel debe tener entre 3 y 40 letras.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    <a href="nivel.php" class="btn btn-outline-danger btn-lg">
                                        <i class='bx bx-arrow-back'></i> Volver a Niveles
                                    </a>
                                    <button type="submit" class="btn btn-danger btn-lg">
                                        <i class='bx bxs-save'></i> Actualizar Nivel
                                    </button>
                                </div>
                            </form>
                        </div>
