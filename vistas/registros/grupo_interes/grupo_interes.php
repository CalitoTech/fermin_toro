                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover align-middle" id="tabla-grupo_interes">
                                    ...
                                    <tbody id="table-body">
                                        <?php foreach ($grupo_interes as $row): ?>
                                            <tr>
                                                <td><?= htmlspecialchars($row['IdGrupo_Interes']) ?></td>
                                                <td><?= htmlspecialchars($row['nombre_grupo']) ?></td>
                                                <td><?= htmlspecialchars($row['nombre'] . ' ' . $row['apellido']) ?></td>
                                                <td><?= htmlspecialchars($row['curso']) ?></td>
                                                <td><?= htmlspecialchars($row['fecha_escolar']) ?></td>
                                                <td>
                                                    <a href="editar_grupo_interes.php?id=<?= $row['IdGrupo_Interes'] ?>" class="btn btn-sm btn-outline-primary me-1">
                                                        <i class='bx bxs-edit'></i>
                                                    </a>
                                                    <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete(<?= $row['IdGrupo_Interes'] ?>)">
