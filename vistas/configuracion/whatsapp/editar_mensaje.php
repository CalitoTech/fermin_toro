...
// Obtener ID del mensaje a editar
$idMensaje = isset($_GET['id']) ? (int)$_GET['id'] : 0;
if ($idMensaje <= 0) {
...
$statusList = $mensajeModel->obtenerStatusInscripcion();
?>

<head>
    <title>UECFT Araure - Editar Mensaje WhatsApp</title>
</head>
                ...
                <div class="col-12 col-lg-10">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-danger text-white text-center">
                            <h4 class="mb-0"><i class='bx bx-message-edit'></i> Editar Mensaje de WhatsApp</h4>
                        </div>
                            ...
                            <form action="../../../controladores/MensajeWhatsappController.php" method="POST" id="formMensaje">
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-select" name="id_status" id="id_status" required>
                                            ...
                                            <?php foreach ($statusList as $status): ?>
                                                <option value="<?= $status['IdStatus'] ?>"
                                                        <?= ($status['IdStatus'] == $mensaje['IdStatus']) ? 'selected' : '' ?>>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="titulo" id="titulo"
                                               value="<?= htmlspecialchars($mensaje['titulo']) ?>"
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <small class="text-muted">
                                            Use las variables: {nombre_representante}, {nombre_estudiante}, {codigo_inscripcion}, {curso}, {seccion}, {cedula_representante}, {fecha_reunion}, {hora_reunion}, {requisitos}, {login_url}
                                        </small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="incluir_requisitos" id="incluir_requisitos"
                                                   <?= $mensaje['incluir_requisitos'] ? 'checked' : '' ?>>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-lg">
                                        <i class='bx bxs-save'></i> Actualizar Mensaje
                                    </button>
                                </div>
                            </form>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreview() {
        ...
        texto = texto.replace(/{hora_reunion}/g, '08:30 AM');
